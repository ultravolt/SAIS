...
namespace DigitalEeel
{
    public static partial class SAIS
    {
        ...
        {
            public Int32 w, h;     // size
            public Int32 pitch;  // how many bytes per hline
            public byte[] data; // linear bitmap
        }

        public class t_ik_sprite : IDisposable
        {
            public Int32 w, h;    // size
            public Int32 co;     // average color
            public byte[] data;    // linear bitmap 
        ...
        {
           public Int32 num;
           public List<t_ik_sprite> spr;
        }

        public class t_ik_font {
            public Int16 w, h;     // size
            public byte[] data;    // linear bitmap 
        };
        ...
        public static t_paletteentry globalpal = new t_paletteentry();// byte[768];
        public static t_paletteentry currentpal = new t_paletteentry();// byte[768];
        ...
        public static t_ik_image ik_load_pcx(string fname, byte[] pal) { throw new NotImplementedException(); }
        ...
        public static void ik_print(t_ik_image img, t_ik_font fnt, Int32 x, Int32 y, int co, char[] ln, params object[] p) { throw new NotImplementedException(); }
        ...
        //public static void ik_dspriteline(t_ik_image img, Int32 xb, Int32 yb, Int32 xe, Int32 ye, Int32 s, Int32 offset, Int32 ybits, t_ik_sprite spr, Int32 flags = 0){ throw new NotImplementedException(); }
    }
}