...
namespace DigitalEeel
{
    public static partial class SAIS
    {
        ...
        public const int STRINGBUFFER_SIZE = 128 * 1024;
        ...
        //public static char[] textstring=new char[STRINGBUFFER_SIZE]; //STR_MAX
        public static List<char[]> textstring = new List<char[]>();

        //public static void textstrings_init() { throw new NotImplementedException(); }
        //public static void textstrings_deinit() { throw new NotImplementedException(); }
