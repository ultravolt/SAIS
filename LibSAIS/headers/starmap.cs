...
namespace DigitalEeel
{
    public static partial class SAIS
    {
        ...
        public class t_hud
        {
            public Int32 invslider;
            public Int32 invselect;
            public Int32 sysslider;
            public Int32 sysselect;
        }


        public class t_starsystem
        {
            public char[] starname = new char[16];
            public char[] planetname = new char[16];
            public Int32 x, y;
            public Int32 color;
            public Int32 planet;
            public Int32 planetgfx;
            public Int32 novadate;
            public Int32 novatype;
            public Int32 novatime;

            public Int32 card;
            public Int32 explored;
            public Int32 ds_x, ds_y;
        }

        public class t_planettype
        {
            public char[] name = new char[16];
            public char[] text = new char[172];
            public Int32 bonus;
        }
        ...
        public class t_player
        {
            ...
            public Int32 nebula;
            public Int32 enroute;

            public Int32 engage;
            public Int32 fold;
            public Int32 hypdate;
            public Int32 foldate;
            public Int32 hyptime;

            public Int32 explore;
            public Int32 stardate;
            public Int32 death;
            public Int32 deatht;
            public Int32 hole;

            public Int32 num_ships;
            public Int32[] ships = new Int32[8];
            public Int32 sel_ship;
            public Int32 sel_ship_time;

            public Int32[] items = new Int32[32];
            public Int32[] itemflags = new Int32[32];
            public Int32 num_items;
            public Int32 bonusdata;
        }
        ...
        public class t_itemtype
        {
            ...
            public char[] clas = new char[32];
            public Int32 type;
            public Int32 cost;
            public Int32 index;
            public Int32 flag;
            public Int32 sound;
            public Int32 loopsnd;
        }
        ...
        public class t_fleet
        {
            ...
            public Int32 distance;
            public Int32 num_ships;
            public Int32[] ships = new Int32[16];
            public Int32 race;
            public Int32 explored;
            public Int32 blowtime;
        }               // enemy "fleet"

        public class t_month
        {
            public char[] name = new char[16];
            public char[] longname = new char[16];
            public Int32 sd, le;
        }
        ...
        {
            public Int32 race;
            public Int32 num_fleets;
            public Int32[] stype = new Int32[3];
            public Int32[,] fleets = new Int32[9, 3];
            public Int32[,] diff = new Int32[3, 10];
        }
        ...
        public static List<char[]> captnames = new List<char[]>();
        public static Int32 num_captnames;
        public static List<char[]> shipnames = new List<char[]>();
